        ...
        {activeProject && (
          <>
            <S.ProjectImgContainer>
              <S.ProjectImg
                src={
                  projectsData[projectsData.findIndex((el) => el.name === activeProject)].data
                    .imgURL
                }
              ></S.ProjectImg>
            </S.ProjectImgContainer>
            ...
            <S.ProjectInfo>
              <S.Title>
                {projectsData[projectsData.findIndex((el) => el.name === activeProject)].fullName}
              </S.Title>
              <S.Text>
                {projectsData[projectsData.findIndex((el) => el.name === activeProject)].data.text}
              </S.Text>
              <S.Stack>
                <S.Accented>Technology used:</S.Accented>{' '}
                {projectsData[projectsData.findIndex((el) => el.name === activeProject)].data.stack}
              </S.Stack>
              ...
              <S.GoTo>
                <S.GoToWebsite
                  ...
                  onClick={() => {
                    window.open(
                      projectsData[projectsData.findIndex((el) => el.name === activeProject)]
                        .website,
                      '_blank',
                    )
                  }}
