...
export const projectsData = [
    {
        ...
        data: {
            ...
            text: 'Multiple Countdowns project allows you to create up to 5 precise countdown timers (precision up to 1ms) that run independently. The precision is achieved with the help of Web Workers with script for each of the countdown timers (instead of using code in the UI thread). Additionally, countdown timers can also "run" offline thanks to local storage, can be stopped and reset and use Notification API on devices with Notification API support.',
    ...
    },
    {
        ...
        data: {
            ...
            text: "This project relies on Github API to get information about profiles and repositories, however due to the fact that Github API has its limits, puppeteer scraper was incorporated as a viable option. The results are the same. Data requested by all users is stored in MongoDB and three latest searches can be accessed at any point without going Github API/scraper route.",
